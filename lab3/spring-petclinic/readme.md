...
3) Inside IntelliJ IDEA
    In the main menu, choose `File -> Open` and select the Petclinic [pom.xml](IdeaProjects/devops/devops-ITMO/lab3/spring-petcliniclinic/pom.xml). Click on the `Open` button.
...
For pull requests, editor preferences are available in the [editor config](IdeaProjects/devops/devops-ITMO/lab3/spring-petcliniclinic/.editorconfig) for easy use in common text editors. Read more and download plugins at <https://editorconfig.org>. If you have not previously done so, please fill out and submit the [Contributor License Agreement](https://cla.pivotal.io/sign/spring).
